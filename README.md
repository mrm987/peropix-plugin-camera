...
도구줄의 「입체 모델로」를 누르면 3등신 모델로 바뀌고, 「마네킹으로」를 누르면 돌아옵니다 (어느 쪽으로 보든
만들어지는 태그는 같습니다). 모델은 **처음 누를 때** 받습니다.
...
- `web/model/character.glb` — 「입체 모델로」에서 세우는 3등신 데포르메 모델. 리깅·애니메이션 없음, +Y 위 · +Z 정면.
