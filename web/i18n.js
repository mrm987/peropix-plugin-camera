...
(function () {
  ...
  var EN = {
    ...
    // 알림
    "이 환경에서는 입체 그림을 그릴 수 없습니다 (WebGL 없음). 태그 만들기는 그대로 됩니다.":
      "This environment cannot draw in 3D (no WebGL). Making tags still works.",
  ...
  var JA = {
    ...
    "이 환경에서는 입체 그림을 그릴 수 없습니다 (WebGL 없음). 태그 만들기는 그대로 됩니다.":
      "この環境では立体表示ができません（WebGL なし）。タグ作成はそのまま使えます。",
