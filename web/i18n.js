...
(function () {
  ...
  var EN = {
    ...
    // 그림 고르기 — 마네킹(기본) ↔ 입체 모델
    "입체 모델로": "3D model", "마네킹으로": "Mannequin", "앞": "front", "뒤": "back",
    ...
    // 알림
    "이 환경에서는 입체 모델을 띄울 수 없습니다 (WebGL 없음).":
      "This environment cannot show the 3D model (no WebGL).",
  ...
  var JA = {
    ...
    "입체 모델로": "立体モデルへ", "마네킹으로": "マネキンへ", "앞": "前", "뒤": "後",
